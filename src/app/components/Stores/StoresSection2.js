      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-12 col-md-6 col-xl-4">
            <div className="card">
              <div>
                <Image className="img-fluid" width={520} height={190} src="/store1.webp" alt="store image" />
              </div>

              <div className="card-body">
                <div className="d-flex justify-content-between">
                  <div>
                    <div className="stores-section2_card-title mb-2">Coimbatore</div>
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div className="me-2 stores-section2_card-text">4.0</div>
                      <div className="stores-section2_card-text text-decoration-underline">496 Google Reviews</div>
                    </div>
                    <div className="stores-section2_card-red-text-bold">View Store Details</div>
                  </div>
                  ...
                  <div>
                   ...
                   <span>
                    ...
                    284 &, 285, Cross Cut Road,
                    Gandhipuram, Tamil Nadu - 641012
                    </div>
                    <div className="stores-section2_card-text mb-2">Phone- <span className="stores-section2_card-yellow-text">+91 82200 17613</span></div>
                    <div className="stores-section2_card-red-text-light mb-2">STORE HOURS: 09:30 A.M. - 08:30 P.M.</div>
                    </div>
