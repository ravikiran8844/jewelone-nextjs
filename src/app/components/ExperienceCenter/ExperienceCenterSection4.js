...
const ExperienceCenterSection4 = () => {
  return (
    <div className='experience-center-section4 container pb-5'>
        ...
        <div className='h2 text-red mb-5'>for all your Wedding Moments</div>
                ...
                740: {
                  ...
                  440: {
                    ...
                    <SplideSlide>
                        ...
                        <div className='h4 text-white position-absolute bottom-0 p-4 experience-center-section2_item text-center'>Sparkling Engagement</div>
                        </div>
                    </SplideSlide>
                    <SplideSlide>
                        <div className='position-relative'>
                        <Image className=' img-fluid  rounded-5' width={310} height={390} src="/experience-center-slider-img2.webp" alt='instagram banner' />
                        <div className='h4 text-white position-absolute bottom-0 p-4 experience-center-section2_item text-center'>Vibrant Haldi</div>
                        </div>
                    </SplideSlide>
                    <SplideSlide>
                        <div className='position-relative'>
                        <Image className=' img-fluid  rounded-5' width={310} height={390} src="/experience-center-slider-img3.webp" alt='instagram banner' />
                        <div className='h4 text-white position-absolute bottom-0 p-4 experience-center-section2_item  text-center'>Exquisite
Mehendi </div>
                        </div>
                    </SplideSlide>
                    <SplideSlide>
                        ...
                        <div className='h4 text-white position-absolute bottom-0 p-4 experience-center-section2_item text-center'>Enchanting
Sangeet</div>
                        </div>
                    </SplideSlide>
                    <SplideSlide>
                        ...
                        <div className='h4 text-white position-absolute bottom-0 p-4 experience-center-section2_item text-center'>Momentous
Muhurtham</div>
                        </div>
                    </SplideSlide>
