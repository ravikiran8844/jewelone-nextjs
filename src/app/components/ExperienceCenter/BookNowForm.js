          ...
          <div className="row">
            ...
            <div className="col-12 col-sm-6 mb-2">
              ...
              {...register("city", { required: true })}
               className="form-control" type="text" placeholder="Enter your city" />
...
{errors.email?.type === "required" && (
            ...
            <div className="d-flex gap-2">
             <div className="d-flex gap-2 align-items-center ">
                ...
                <div>
                    <input {...register("factoryVisit", { required: false })} id="factory-visit-yes" type="radio" name="factory-visit" />
                </div>
              </div>
              <div className="d-flex gap-2 align-items-center">
                <label className="book-now-form_labels " htmlFor="factory-visit-no">No</label>
                <div>
                    <input {...register("factoryVisit", { required: false })} id="factory-visit-no"  type="radio"  name="factory-visit" />
                </div>
              </div>
             </div>
            </div>
            ...
            <div className="col-12 col-sm-6 mb-3 m-auto">
              <div>
                <button type="submit" className="btn form-control bg-red text-white">
                    SUBMIT
                  </button>
              </div>
            </div>
