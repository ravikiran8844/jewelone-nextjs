    ...
    <footer className="footer-section py-5">
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-7 col-lg-8">
            <div className="footer-section_items">
              {/* Information */}
              <div>
                <div className="mb-3 footer-section_links_label">Information</div>
              ...
              {/* Contact Us */}
              <div>
                <div className="mb-3 footer-section_links_label">Contact Us</div>
                <ul className="list-unstyled">
                  <li>
                    <span className='me-2'>
                      <svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_2727_999)">
                          <path d="M12.2948 9.18442C12.2948 9.91242 11.699 10.5284 10.9948 10.5284H3.30312L0.703125 13.2164V2.57642C0.703125 1.84842 1.29896 1.23242 2.00312 1.23242H11.049C11.7531 1.23242 12.349 1.84842 12.349 2.57642V9.18442H12.2948Z" stroke="white" stroke-linecap="round" stroke-linejoin="round"></path>
                        </g>
                        <defs>
      ...
      >
        <g clipPath="url(#clip0_2727_988)">
          <path d="M14.856 2.85742H1.14119C0.983392 2.85742 0.855469 2.98535 0.855469 3.14315V12.8578C0.855469 13.0156 0.983392 13.1435 1.14119 13.1435H14.856C15.0138 13.1435 15.1417 13.0156 15.1417 12.8578V3.14315C15.1417 2.98535 15.0138 2.85742 14.856 2.85742Z" stroke="white"></path>
          <path d="M14.9976 3L8.19054 10.3037C8.16717 10.3288 8.13887 10.3489 8.10741 10.3626C8.07595 10.3763 8.042 10.3833 8.00768 10.3833C7.97336 10.3833 7.93941 10.3763 7.90795 10.3626C7.87649 10.3489 7.84819 10.3288 7.82482 10.3037L1 3" stroke="white"></path>
        </g>
        <defs>
          <clipPath id="clip0_2727_988">
            <rect width="16" height="16" fill="white"></rect>
              ...
              <div>
                <div className="mb-3 footer-section_links_label">Swarna Shakti App Download</div>
            ...
            <div className="mt-4 d-flex flex-column g-3 flex-md-row justify-content-between flex-wrap" style={{ borderTop: '1px solid #84141E', paddingTop: '10px' }}>
              {/* Follow Us */}
              <div>
    ...
    >
      ...
      ></path>
              ...
              <div className="align-self-md-end mt-3">
                <div className="footer-section_text">© 2023 JewelOne. All Rights Reserved. </div>
              </div>
            </div>
          </div>
        </div>
