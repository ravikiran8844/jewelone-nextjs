    ...
    <div className='instagram-grid-section home-section6 section-padding'>
        <div className='container'>
            <div className='col-12 text-center mb-4'>
                ...
                <span className="me-2"><svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" viewBox="0 0 39 39" fill="none">
            ...
            <div className='text-center mb-5 instagram-grid-section_text'>Follow <b>JEWELONE</b> on Instagram and be part of the movement</div>
