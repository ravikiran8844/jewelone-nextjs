    ...
    <div className='instagram-grid-section home-section6 py-5'>
        <div className='container'>
            <div className='col-12 text-center mb-5'>
                ...
                <span class="me-2"><svg xmlns="http://www.w3.org/2000/svg" width="39" height="39" viewBox="0 0 39 39" fill="none">
            ...
            <Splide options={ {
             ...
             <SplideSlide>
              ...
              <SplideSlide>
              <a target='__blank' href='https://www.instagram.com/'>
              <Image width={316} height={316} src="/instagram2.webp" />
              </a>

              </SplideSlide>
              <SplideSlide>
              <a target='__blank' href='https://www.instagram.com/'>
              <Image width={316} height={316} src="/instagram3.webp" />
              </a>

              </SplideSlide>
              <SplideSlide>
              <a target='__blank' href='https://www.instagram.com/'>
              <Image width={316} height={316} src="/instagram4.webp" />
              </a>

              </SplideSlide>
              <SplideSlide>
              <a target='__blank' href='https://www.instagram.com/'>
              <Image width={316} height={316} src="/instagram5.webp" />
              </a>
