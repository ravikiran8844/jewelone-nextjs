...
const LISTINGS = [
  {
    ...
    addressLines: [
      "No. 284 & 285, Cross Cut Rd",
      "Peranaidu Layout, Ram Nagar, Gandhipuram",
  ...
  },
  {
    ...
    addressLines: [
      "SF. NO. 460, 461/1 Kathirnaickenpalayam Road",
      "Post, Thoppampatti, Coimbatore, Narasimhanaickenpalayam",
      "Tamil Nadu 641017, India",
    ],
  ...
  },
  {
    ...
    addressLines: [
      "Near Thirumangalam Metro station",
      "233-235, 2nd Ave, L Block, Anna Nagar West, Anna Nagar",
  ...
  },
  {
    ...
    addressLines: [
      "123, Netaji Rd, opposite Modern Restaurant",
  ...
  },
  {
    ...
    addressLines: [
      "18/1, Anna Salai, opp. Voorhees College",
      "Vasanthapuram, Srinivasan Nagar, Vellore, Tamil Nadu 632001, India",
    ],
  ...
  },
  {
    ...
    addressLines: [
      "65 Swamy Vivekanda, Salai St, Chalai Bazar",
      "Ramanathapuram, Tamil Nadu 623501, India",
    ],
  ...
  },
  {
    ...
    addressLines: [
      "1/2, Omalur Main Rd, Arthanari Nagar, Swarnapuri",
  ...
  },
  {
    ...
    addressLines: [
      "Narasus Coffee Opp, 34, Bazaar St, Puliampatti",
  ...
  },
  {
    ...
    addressLines: [
      "88, Kamaraj Salai, Near Jayaram Hotel",
      "Kamaraj Nagar, Puducherry, 605011, India",
    ],
  ...
  },
  {
    ...
    addressLines: [
      "NO.8, OPP HOSUR BUS STAND, NEAR FLOWER MARKET",
      "Surya Nagar, Sri Nagar, Hosur, Tamil Nadu 635109, India",
    ],
